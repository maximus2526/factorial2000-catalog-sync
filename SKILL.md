...
> Остання актуальна версія: **0.6.10**
> Тестове покриття: **251 тест / 1168 асертів**, PHPCS чистий у всіх файлах.
...
- Робоча гілка містить некомічені зміни релізу 0.6.10 (фікс ініціалізації Freemius: wizard після активації)
